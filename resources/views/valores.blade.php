<x-layout>
    @section('content')
        ...
        <div class="flex flex-row justify-center mx-auto p-4 w-full">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-10 text-center items-center">
                <div
                    class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">

                    <div class="p-5">
                        <h5 class="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white">Compromiso con las
                            personas sordas
                        </h5>
                    </div>
                </div>
